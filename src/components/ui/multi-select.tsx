...
export function MultiSelect({
  ...
  // Mobile: inline dropdown (no portal, avoids Dialog scroll lock conflict)
  if (isMobile) {
    return (
        ...
        {open && (
          <div className="mt-1 rounded-md border bg-popover shadow-md">
            <div className="max-h-[40vh] overflow-y-auto overscroll-contain p-1">
              <OptionsList options={options} selected={selected} onSelect={handleSelect} />
            </div>
          </div>
        )}
      </div>
